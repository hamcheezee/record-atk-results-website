    ...
    <table class="table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <button id="add" class="btn btn-primary" onclick="addButton()">add</button>
                    <button id="delete" class="btn btn-danger" onclick="deleteButton()">delete</button>
                </td>
            </tr>
        </tbody>
    </table>

    <h3 style="font-size: 1.3rem; text-align: center;">Your request is now: </h3>
    <h3 id="request" style="font-size: 1.3rem; text-align: center;">0</h3>
    <!-- bed facility section ends  -->
